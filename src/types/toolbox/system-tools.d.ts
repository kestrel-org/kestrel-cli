...
export interface KcSystem {
    ...
    */
    async spawn(params : {commandLine: string,args?: string,options?: SpawnOpts}): Promise<SpawnResult>,
    ...
    */
    async run(commandLine: string,args? : string,options: RunOptions = {}): Promise<string>
}