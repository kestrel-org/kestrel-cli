 ...
 */
function getPrompts(router_name : string, models : PromptsModels[], paths : PathObject) : prompts.PromptObject[] {
    const {
        ...
        },
        {
            type: (prev : any, values : any, prompt : any) => {
                if(values.createService){
                    const service_found = find(paths.services_path,{matching : [`${paths.service_name}.service.ts`,`${paths.service_name}.service.spec.ts`]})
