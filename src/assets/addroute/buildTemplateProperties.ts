 ...
 */
function buildTemplateProperties(model : string,database : Database, path : string | null=null, path_to_model : string | null=null, path_to_app : string | null=null) : AddProps {
